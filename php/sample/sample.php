<?php
    ...
    $recordingKey = generateRecordingKey($staticKey, $signKey, $channelName, $ts, $randomInt, $uid, $expiredTs);
    echo('recordingKey : ' . $recordingKey . '<br /><br />');

	$mediaChannelKey = generateMediaChannelKey($staticKey, $signKey, $channelName, $ts, $randomInt, $uid, $expiredTs);
