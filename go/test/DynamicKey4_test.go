...
func Test_PublicSharingKey(t *testing.T) {
	...
	key := DynamicKey4.GeneratePublicSharingKey(vendorKey, signKey, channelName, unixTs, randomInt, uid, expiredTs)
...
func Test_RecordingKey(t *testing.T) {
	...
	randomInt:=uint32(58964981)
	expiredTs:=uint32(1446455471)
	key := DynamicKey4.GenerateRecordingKey(vendorKey, signKey, channelName, unixTs, randomInt, uid, expiredTs)
...
func Test_MediaChannelKey(t *testing.T) {
	...
	randomInt:=uint32(58964981)
	expiredTs:=uint32(1446455471)
	key := DynamicKey4.GenerateMediaChannelKey(vendorKey, signKey, channelName, unixTs, randomInt, uid, expiredTs)
